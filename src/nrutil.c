...
int MemoryUsage(void)
{
  if (locnint > 1000 || locnfloat > 1000)
    printf("Memory used real %d %d %d int %d %d %d\n", nfloat, cumnfloat,
           locnfloat, nint, cumnint, locnint);
  locnfloat = locnint = 0;
}
#endif
...
/* allocate an unsigned char vector with subscript range v[nl..nh] */
{
  ...
  v = (unsigned char *)malloc((size_t)(nh - nl + 1 + 1) *
...
/* allocate an unsigned long vector with subscript range v[nl..nh] */
{
  ...
  v = (unsigned long *)malloc((size_t)(nh - nl + 1 + 1) *
...
/* allocate a double 3tensor with range t[nrl..nrh][ncl..nch][ndl..ndh] */
{
  ...
  t[nrl][ncl] =
      (double *)malloc((size_t)((nrow * ncol * ndep + 1) * sizeof(double)));
  if (!t[nrl][ncl])
...
// void free_vector(float *v, int nl, int nh) { free((FREE_ARG)(v + nl - 1)); }
void free_vector(float *v, int nl) { free((FREE_ARG)(v + nl - 1)); }
...
void free_f3tensor(double ***t, int nrl, int nrh, int ncl, int nch, int ndl,
                   int ndh)
{
